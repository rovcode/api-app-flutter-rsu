...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold">32</h3>
                                    <h5 class="mb-0 font-weight-medium text-primary">Bodegas</h5>
                        ...
                        <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold">80</h3>
                                    <h5 class="mb-0 font-weight-medium text-primary">Recetas</h5>
                        ...
                        <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    <h3 class="mb-0 font-weight-semibold">800</h3>
                                    <h5 class="mb-0 font-weight-medium text-primary">Usuarios Activos</h5>
                        ...
                        <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    ...
                                    <h5 class="mb-0 font-weight-medium text-primary">Total de usuarios</h5>
                                    <p class="mb-0 text-muted">+138.97(+0.54%)</p>
                                </div>
                                <div class="wrapper my-auto ml-auto ml-lg-4">
    ...
    <div class="row">
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-0">Pedidos recientes</h4>
                    <div class="d-flex py-2 border-bottom">
                        <div class="wrapper">
                            <small class="text-muted">15 Feb, 2021</small>
                            <p class="font-weight-semibold text-gray mb-0">Pedido receta <span>Sopa de pollo</span></p>
                        </div>
                        <small class="ml-auto text-warning">En proceso</small>
                    </div>
                    <div class="d-flex py-2 border-bottom">
                        <div class="wrapper">
                            <small class="text-muted">15 Feb, 2021</small>
                            <p class="font-weight-semibold text-gray mb-0">Pedido receta <span>Receta dos</span></p>
                        </div>
                        <small class="text-success ml-auto">Finalizado</small>
                    </div>
                    <div class="d-flex py-2 border-bottom">
                        <div class="wrapper">
                            <small class="text-muted">15 Feb, 2021</small>
                            <p class="font-weight-semibold text-gray mb-0">Pedido receta <span>Sopa de carne</span></p>
                        </div>
                        <small class="text-danger ml-auto">Cancelado</small>
                    </div>
                    <div class="d-flex pt-2">
                        <div class="wrapper">
                            <small class="text-muted">15 Feb, 2021</small>
                            <p class="font-weight-semibold text-gray mb-0">Pedido receta <span>Ensalada</span></p>
                        </div>
                        <small class="text-success ml-auto">Finalizado</small>
                    </div>
                    <a class="d-block mt-5" href="#">Ver todos</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between pb-3">
                        ...
                        <p class="mb-0 text-muted">05 Enero 2021</p>
                    </div>
                    <ul class="timeline">
                        <li class="timeline-item">
                            <p class="timeline-content"><a href="#">Rony Velásquez</a> nuevo usuario</p>
                            <p class="event-time">Justo ahora</p>
                        </li>
                        <li class="timeline-item">
                            <p class="timeline-content"><a href="#">Delifaxil User</a> nuevo usuario</p>
                            <p class="event-time">Justo ahora</p>
                        </li>
                        <li class="timeline-item">
                            <p class="timeline-content"><a href="#">Ben Tossell</a> nuevo usuario</p>
                            <p class="event-time">Justo ahora</p>
                        </li>
                        <li class="timeline-item">
                            <p class="timeline-content"><a href="#">Ben Tossell</a> nuevo usuario</p>
                    ...
                    <a class="d-block mt-3" href="#">Ver Todos</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-0">Nuevas Sucripciones</h4>
                    <div class="table-responsive">
                        <table class="table table-stretched">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <p class="mb-1 text-dark font-weight-medium">SUPER CHEF</p><small
                                            class="font-weight-medium">Rony Velásquez</small>
                                    </td>
                                    <td class="font-weight-medium">S/ 15.00 </td>
                                    <td class="text-success font-weight-medium">Trujillo</td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="mb-1 text-dark font-weight-medium">SUPER CHEF</p><small
                                    ...
                                    <td class="font-weight-medium">S/ 15.00</td>
                                    <td class="text-danger font-weight-medium">Trujillo</td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="mb-1 text-dark font-weight-medium">DELI CHEF</p><small
                                            class="font-weight-medium">Rony Velásquez</small>
                                    </td>
                                    <td class="font-weight-medium">S/ 15.00 </td>
                                    <td class="text-danger font-weight-medium">Huaraz</td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="mb-1 text-dark font-weight-medium">MASTER CHEF</p><small
                                            class="font-weight-medium">Rony Velásquez.</small>
                                    </td>
                                    <td class="font-weight-medium">S/ 15.00 </td>
                                    <td class="text-success font-weight-medium">Huaraz</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
